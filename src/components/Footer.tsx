          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-3 text-sm font-body">
                ...
                <p className="text-muted-foreground">4c Dernier Sol L-2543 Bouneweg-Süd Luxembourg</p>
                <p className="text-muted-foreground">+352 661 822 010 Luxembourg</p>
                <p className="text-muted-foreground">+221 77 630 13 34 Senegal</p>
                <p className="text-muted-foreground">+1 (909) 735-2062 USA</p>
                <div className="pt-2">
